...
1. Активити взаимодействие со слоем domain должно осуществлять через ViewModel.
2. Обновление состояния интерфейса осуществлять через LiveData.
3. Самостоятельно изучить MediatorLiveData и получить данные из замоканных данных из сетевой части и БД.
...
Наблюдатели в MainActivity. Настроены Observer'ы для реактивного обновления UI:
```
...
MediatorLiveData объединяет данные из БД и сети без дубликатов
